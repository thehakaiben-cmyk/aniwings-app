...
export default function Home({ updateData }) {
  const DEFAULT_GITHUB_RELEASE_URL = 'https://github.com/thehakaiben-cmyk/aniwings-app/releases/download/v1.2.0/AniWings-universal.apk';
  const DEFAULT_TV_RELEASE_URL = 'https://github.com/thehakaiben-cmyk/aniwings-app/releases/download/tv-v1.2.2/aniwings-tv-v1.2.2-universal.apk';
  ...
  const fileSize = updateData?.fileSize || '120.3 MB';
  ...
  const tvFileSize = tvData?.fileSize || '66.9 MB';
              ...
              <div className="release-notes-card" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px', marginBottom: '0.75rem' }}>
                  <h4 style={{ fontSize: '1.1rem', color: '#ffffff', display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }}>
                    ...
                    Mobile v{updateData?.version || '1.2.0'} Release Notes
                  </h4>
              ...
              <div className="release-notes-card" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px', marginBottom: '0.75rem' }}>
                  <h4 style={{ fontSize: '1.1rem', color: '#ffffff', display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }}>
                    ...
                    Android TV v{tvData?.version || '1.2.2'} Release Notes
                  </h4>
                  <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                    Released: {tvData?.updatedAt || '2026-09-20'}
                  </span>
                </div>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: '1.6', margin: 0 }}>
                  {tvData.releaseNotes}
